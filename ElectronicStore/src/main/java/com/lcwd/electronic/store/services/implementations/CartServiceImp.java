...
import com.lcwd.electronic.store.repositories.CardItemRepository;
...
//
//        if (quantity <=0){
//            throw new BadApiRequest("Requested quantity has not valid ! ");
//        }
...
//        cart.setItems(updatedItems);
    ...
    public void removeItemFromCart(String userId, int cartItem) {
        ...
        CartItem cartItem1 = cardItemRepository.findById(cartItem).orElseThrow(() -> new ResourceNotFoundException("Card item not found in db"));
